...
description: | 
    A labeled dataset of more than 4000 legal texts mapped to different categories of potentially anticompetitive provisions
format: 
    html:
        code-fold: true
