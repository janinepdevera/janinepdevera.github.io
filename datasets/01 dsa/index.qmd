...
**EU Digital Speeches Dataset** (39 MB)<br> 
4078 rows<br>
<a class='third-hover' href='https://github.com/janinepdevera/scraper-eu-press/blob/main/data/eu-digital-speeches.csv'>Download here</a><br>
...
df = pd.read_csv('./data/01 digital speeches.csv', index_col=0)
df_sample = df[:99]
